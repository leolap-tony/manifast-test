...
export default function MyGroupInformation({
  ...
  return (
    <div>
      ...
      <ul className="flex flex-col gap-3 px-6 mb-6">
        <li>
          <KeyValueLabel direction="row" label="상호명" labelWidth={86}>
            상호명
          </KeyValueLabel>
        </li>
        <li>
          <KeyValueLabel direction="row" label="대표자" labelWidth={86}>
            {group.businessInfo?.ceoName}
          </KeyValueLabel>
        </li>
        <li>
          <KeyValueLabel direction="row" label="사업자등록번호" labelWidth={86}>
            {group.businessInfo?.businessNumber}
          </KeyValueLabel>
        </li>
        <li>
          <KeyValueLabel direction="row" label="주소" labelWidth={86}>
            주소
          </KeyValueLabel>
        </li>
        <li>
          <KeyValueLabel direction="row" label="사업 카테고리" labelWidth={86}>
            사업 카테고리
          </KeyValueLabel>
        </li>
        <li>
          <KeyValueLabel direction="row" label="규모" labelWidth={86}>
            규모
          </KeyValueLabel>
        </li>
        <li>
          <KeyValueLabel direction="row" label="인원" labelWidth={86}>
            인원
          </KeyValueLabel>
        </li>
      </ul>
