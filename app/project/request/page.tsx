  ...
  return (
    <form action={createProject} className='flex flex-col gap-6 w-full p-8'>
          ...
          <div className='flex p-1 gap-3'>
            ...
            <Select name='type' onValueChange={(value)=>setType(value)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="contents">콘텐츠 디자인 (SNS 피드/카드뉴스)</SelectItem>
                <SelectItem value="print">인쇄물 디자인 (명함) / 사이니지 디자인 (디지털 배너)</SelectItem>
                <SelectItem value="print">인쇄물 디자인 (리플랫/책자)</SelectItem>
                <SelectItem value="ppt">PPT 디자인</SelectItem>
                <SelectItem value="ux">UX 리서치 </SelectItem>
                <SelectItem value="motiongraphic">2D / 3D 모션 그래픽</SelectItem>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <Textarea name='message' placeholder="Type your message here." id="message-2" />
      </div>
      ...
      <input type='hidden' name='tasks' value={JSON.stringify(TASKS[`${type}`])}/>
      {TASKS[`${type}`].map((task:Task)=> <input type='hidden' name='tasklist' value={JSON.stringify(task)}/>)}      
